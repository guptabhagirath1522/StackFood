...
class CheckoutRepository implements CheckoutRepositoryInterface {
  ...
  Future<Response> placeOrder(PlaceOrderBodyModel orderBody) async {
    ...
    print(
        '========Cart items: ${orderBody.cart?.map((item) => item.toJson()).toList()}=====================');
    print('========isBuyNow value: ${orderBody.isBuyNow}=====================');
    return await apiClient.postData(AppConstants.placeOrderUri, orderData);
  }
